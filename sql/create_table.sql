...
(
    ...
    PASSPORT_NUMBER      NVARCHAR2(255) NOT NULL,
    ADDRESS_REGISTRATION NVARCHAR2 (255) NOT NULL,
    ADDRESS_RESIDENTIAL  NVARCHAR2 (255),
    MOBILE_PHONE         NVARCHAR2(255) NOT NULL,
    EMAIL                NVARCHAR2(255),
    PRIMARY KEY (ID_CLIENT)
);

CREATE INDEX INDEX_CLIENT_01 ON CLIENT (LAST_NAME, FIRST_NAME, MIDDLE_NAME);
CREATE INDEX INDEX_CLIENT_02 ON CLIENT (PASSPORT_NUMBER);

CREATE TABLE ACCOUNT
(
    ID_ACCOUNT     NUMBER(19) GENERATED BY DEFAULT AS IDENTITY,
    ID_CLIENT      NUMBER(19) NOT NULL,
    TYPE_ACCOUNT   NVARCHAR2(255) NOT NULL,
    ACCOUNT_NUMBER NVARCHAR2(255) NOT NULL,
    PRIMARY KEY (ID_ACCOUNT),
    FOREIGN KEY (ID_CLIENT) REFERENCES CLIENT (ID_CLIENT)
);
CREATE UNIQUE INDEX INDEX_ACCOUNT_01 ON ACCOUNT (ACCOUNT_NUMBER);
...
CREATE INDEX INDEX_APPLICATION_01 ON APPLICATION (FROM_ACCOUNT);
CREATE INDEX INDEX_APPLICATION_02 ON APPLICATION (CREATION_DATE);
...
(
    ...
    MONEY          DECIMAL NOT NULL,
    PAYMENT_STATUS NVARCHAR2(255) NOT NULL,
...
CREATE INDEX INDEX_PAYMENT_01 ON PAYMENT (ID_APP);
